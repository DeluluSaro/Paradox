    ...
    <div
      ...
      <div
        ...
        <div className="flex gap-6 mt-8">
          <button
            onClick={() => router.back()}
            className="group text-black border-2 border-black hover:bg-black hover:text-white transition-all duration-300 ease-in-out px-6 py-2 h-auto text-base font-medium flex items-center gap-2 hover:scale-105 rounded-full">
            <svg
          ...
          <button
            onClick={() => router.push("/")}
            className="group bg-black text-white hover:bg-gray-900 transition-all duration-300 ease-in-out px-6 py-2 h-auto text-base font-medium flex items-center gap-2 hover:scale-105 rounded-full">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="20"
